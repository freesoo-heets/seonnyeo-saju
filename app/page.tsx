  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f7f1e8] text-[#3f343a]">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute right-[5%] top-12 text-[180px] leading-none text-[#6b4d64]/[0.035]">
          
        </div>

        <div className="absolute left-[7%] top-[42%] text-4xl text-[#ae9060]/10">
          
        </div>

        <div className="absolute bottom-[20%] right-[10%] text-3xl text-[#72566b]/10">
      ...
      <header className="relative z-10 mx-auto max-w-6xl px-5 pt-5 sm:px-7 sm:pt-7">
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-full border border-[#c9b181] bg-[#faf3e6] text-xl text-[#72546a] shadow-sm">
      ...
      <section className="relative z-10 mx-auto max-w-6xl px-5 pb-16 pt-16 sm:px-7 sm:pb-24 sm:pt-24">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full border border-[#cbb383] bg-[#faf2e4] text-3xl text-[#76576e] shadow-[0_8px_30px_rgba(81,55,72,0.08)]">
          ...
          <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <div className="flex min-h-14 items-center justify-center rounded-2xl border border-[#dacdbb] bg-[#fffaf3]/80 px-6 text-sm font-semibold text-[#71636a] backdrop-blur">
              <InstallAppButton />
            </div>
            ...
            <div className="mx-auto mt-8 grid max-w-2xl grid-cols-4 gap-2 sm:gap-4">
              ...
              {[
                ...
                >
                  ...
                  <p className="font-serif text-3xl text-[#654a5d] sm:text-4xl">
                    {hanja}
                  </p>

                  <p className="mt-3 text-xs font-bold text-[#5d5056] sm:text-sm">
                    {name}
                  </p>

                  <p className="mt-1 hidden text-[10px] text-[#a39790] sm:block">
                    {description}
                  </p>
                </div>
              ))}
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {[
            [
              "01",
              "정보 입력",
              "생년월일과 태어난 시간, 궁금한 이야기를 입력합니다.",
              "",
            ],
            [
              "02",
              "만세력 확인",
              "입력된 정보를 기준으로 사주 원국과 오행을 확인합니다.",
              "",
            ],
            [
              "03",
              "선녀의 풀이",
              "사주의 흐름과 질문을 바탕으로 직접 풀이합니다.",
              "",
            ],
            [
              "04",
              "결과 확인",
              "전용 결과 링크와 PIN으로 편리하게 확인합니다.",
              "",
            ],
            ...
            >
              <div className="flex items-center justify-between">
                <span className="font-serif text-xl text-[#b29461]">
                  {number}
                </span>
              ...
              <h3 className="mt-5 font-serif text-lg font-semibold text-[#493943]">
                {title}
              </h3>

              <p className="mt-2 text-sm leading-6 text-[#91857f]">
                {description}
              </p>
            </div>
          ))}
      ...
      <section className="relative z-10 mx-auto max-w-5xl px-5 pb-16 sm:px-7 sm:pb-24">
        ...
        <div className="relative overflow-hidden rounded-[30px] border border-[#5c4055] bg-[#594052] px-6 py-10 text-center text-white shadow-[0_22px_60px_rgba(70,44,62,0.18)] sm:px-10 sm:py-14">
          ...
          <div className="pointer-events-none absolute bottom-[-65px] left-10 text-[180px] leading-none text-white/[0.025]">
      ...
      <footer className="relative z-10 border-t border-[#dfd4c6]/70 px-5 py-9 text-center">
        ...
        <p className="mt-3 font-serif text-sm font-semibold text-[#65565e]">
          선녀사주
        </p>

        <p className="mt-1 text-[9px] tracking-[0.22em] text-[#aaa09a]">
          SEONNYEO SAJU
        </p>

        <p className="mt-4 text-[10px] text-[#b0a69f]">
          개인 사주 상담
        </p>
